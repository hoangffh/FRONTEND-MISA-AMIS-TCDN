<template>
  <div class="container-menu">
    <div class="container-menu-title">
      <div class="container-menu-title-left">
        <span>Nhóm vật tư hàng hóa ,dịch vụ</span>
    ...
    <div class="container-menu-content">
      <div class="container-menu-content-head">
        <div class="container-menu-content-head-left">
          <BaseInput
            ...
            width="300px"
            height="34px"
            placeholder="Tìm theo nhóm vật tư , hàng hóa , dịch vụ"
            :search="true"
            ref="employeeFilterRef"
            relative="relative"
            @onChangeValue="onChangeValue"
            v-model="groupCategoryTextSearch"
          />
        </div>
        <div class="container-menu-content-head-right">
          <div class="a-padd-l-10px container-menu-content-head-reload"></div>
      ...
      <BaseTable
        :data="groupCategory"
        :listCols="displayFieldGroupCategory"
        :existFooter="false"
        :isShowCheckBox="false"
        fieldValue="GroupCategoryId"
        fieldValueCode="GroupCategoryCode"
        textColor="#000"
  ...
  <GroupCategoryPopUpDetail
    ...
    :formMode="formMode"
    :groupCategorySelected="groupCategorySelected"
...
import GroupCategoryPopUpDetail from "./groupCategoryPopUpDetail.vue";
...
export default {
  ...
  data() {
    return {
      ...
      totalPage: 10,
      groupCategory: [],
      groupCategoryTextSearch: "",
      isShowPopUp: false,
      displayFieldGroupCategory: [
        {
        ...
        {
          display:Resources.MiSaResource.GroupCategory.GroupCategoryStatusTable,
          name: "UsingStatus",
          width: "150",
          align: "left",
        },
      ...
      groupCategoryIdDelete: null,
      groupCategoryCodeDelete: null,
      isShowDialogErr: false,
      diaglogErrorMessage: null,
      groupCategorySelected:null,
  ...
  methods: {
    ...
    {
      this.linkExport = "https://localhost:44358/api/v1/GroupCategory/export"
    },
    handleLoadData() {
      this.loadData();
    },
    ...
    handleClickRemove(id, code) {
      this.groupCategoryIdDelete = id;
      this.groupCategoryCodeDelete = code;
      this.isShowDialogNotify = true;
      this.messageDialogNotifi = `Bạn có thực sự muốn xóa Nhóm vật tư , hàng hóa <${code}> không ?`;
    },
    /*
    ...
    */
    allowDeleteEmoloyee() {
      ...
      me.apiDeleteMethod(me.groupCategoryIdDelete);
    },
    /*
    ...
    */
    async apiDeleteMethod(id) {
      ...
      try {
        me.isloading = true;
        await axios
          .delete(`https://localhost:44358/api/v1/GroupCategory/${id}`)
          .then(function () {
          ...
          .catch(function (res) {
            if (res.response.status == 500) {
              ...
              me.diaglogErrorMessage = `Nhóm Vật tư hàng hóa <${me.groupCategoryCodeDelete}> đã có phát sinh. Bạn phải xóa các phát sinh liên quan trước khi xóa vật tư hàng hóa`;
              me.isloading = false;
            }
          });
      } catch (error) {
     ...
     async handleClickView(id)
      {
        ...
        try {
          ...
          await axios
            .get(`https://localhost:44358/api/v1/GroupCategory/${id}`)
            .then(function (res) {
              _this.groupCategorySelected = res.data;
    ...
    */
    ...
    onChangeValue(value) {
      ...
      _this.myTimeOut = setTimeout(() => {
        ...
        axios
          .get(
            `https://localhost:44358/api/v1/GroupCategory/paging?pageSize=10&pageNumber=1&textSearch=${
              value || ""
            }`
          )
          .then(function (res) {
            _this.groupCategory = res.data.warehouses;
    ...
    async loadData() {
      ...
      try {
        ...
        await axios
          .get(
            "https://localhost:44358/api/v1/GroupCategory/paging?pageSize=10&pageNumber=1"
          )
          .then(function (res) {
            _this.isloading = false;
            _this.groupCategory = res.data.warehouses;
    ...
    async onPageChange() {
      ...
      await axios
        .get(
          `https://localhost:44358/api/v1/GroupCategory/paging?pageSize=${_this.recordInPage}&pageNumber=${_this.page}&textSearch=${_this.groupCategoryTextSearch}`
        )
        .then(function (res) {
          _this.groupCategory = res.data.warehouses;
          _this.isloading = false;
